      ...
      case "single":
        return (
          <div className="flex justify-center">
            <SwitchableVideoPlayer videoUrl={videoUrl} />
          </div>
        );
      case "multi":
  ...
  return (
    <div className="min-h-screen flex flex-col bg-neutral-900 text-white font-sans">
      <header className="bg-black bg-opacity-80 shadow-lg px-6 py-4 flex items-center justify-between">
        <h1 className="text-3xl font-extrabold tracking-wider text-red-600">
          MyStream
        </h1>
          ...
          <button
            className={`px-4 py-2 rounded ${
              activeTab === "single"
                ...
                : "bg-neutral-800 text-gray-200 hover:bg-red-600 hover:text-white transition"
            }`}
      ...
      <main className="flex-1 px-4 py-8">{renderContent()}</main>
